...
This example demonstrates :class:`~tanat.metric.sequence.EditSequenceMetric`,
which computes Needleman-Wunsch edit distance between sequences with
configurable insertion/deletion penalties.
"""
...
metric = EditSequenceMetric(entity_metric=hamming, indel_cost=1.0, normalize=True)
print(metric)
...
ax.set_title("Edit distance matrix", fontsize=12, fontweight="bold")
