...
This example demonstrates :class:`~tanat.metric.sequence.LCSSequenceMetric`,
which computes a distance derived from the Longest Common Subsequence between
two temporal sequences.
"""
