...
This example demonstrates :class:`~tanat.metric.sequence.SoftDTWSequenceMetric`,
a differentiable variant of DTW controlled by a smoothing parameter ``gamma``.
"""
...
metric = SoftDTWSequenceMetric(entity_metric=hamming, gamma=0.5)
print(metric)
...
ax.set_title("SoftDTW distance matrix", fontsize=12, fontweight="bold")
