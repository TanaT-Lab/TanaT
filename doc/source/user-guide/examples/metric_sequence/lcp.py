...
This example demonstrates :class:`~tanat.metric.sequence.LCPSequenceMetric`,
which computes the Longest Common Prefix distance between two temporal
sequences.
"""
...
metric = LCPSequenceMetric(entity_metric=hamming, mode="normalized")
print(metric)
...
ax.set_title("LCP distance matrix", fontsize=12, fontweight="bold")
